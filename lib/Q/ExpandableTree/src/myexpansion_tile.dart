...
///
/// {@tool dartpad}
/// This example demonstrates different configurations of MyExpansionTile.
///
...
class MyExpansionTile extends StatefulWidget {
  ...
  /// Used to override to the [ListTileThemeData.textColor].
  ///
  /// If this property is null then [MyExpansionTileThemeData.collapsedTextColor] is used. If that
  /// is also null then the value of [ListTileThemeData.textColor] is used.
  ///
  /// See also:
  ///
...
class _MyExpansionTileState extends State<MyExpansionTile>
  ...
  void setExpanded(bool doExpand) {
    if (doExpand != _isExpanded) _handleTap();
  }
